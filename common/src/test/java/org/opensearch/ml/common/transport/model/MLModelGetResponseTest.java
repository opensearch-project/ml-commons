    ...
    public void toXContentTest() throws IOException {
        ...
        assertEquals(
            "{\"name\":\"model\","
                ...
                + "\"user\":{\"name\":\"\",\"backend_roles\":[],\"roles\":[],\"custom_attribute_names\":[],\"custom_attributes\":{},\"user_requested_tenant_access\":null,\"user_requested_tenant\":null},\"model_state\":\"TRAINED\"}",
            jsonStr
        );
    }
