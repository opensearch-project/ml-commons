...
public class MLConfigGetResponseTest {
    ...
    public void writeTo() throws IOException {
        ...
        mlConfig = new MLConfig("olly_agent", null, new Configuration("agent_id"), null, Instant.EPOCH, Instant.EPOCH, Instant.EPOCH, null);
        MLConfigGetResponse mlConfigGetResponse = MLConfigGetResponse.builder().mlConfig(mlConfig).build();
    ...
    public void toXContent() throws IOException {
        mlConfig = new MLConfig(null, null, null, null, null, null, null, null);
        MLConfigGetResponse mlConfigGetResponse = MLConfigGetResponse.builder().mlConfig(mlConfig).build();
