...
public class MLUpdateControllerRequestTest {
    ...
    public void setUp() throws Exception {
        ...
        updateControllerInput = MLController.builder().modelId("testModelId").userRateLimiter(new HashMap<>() {
            {
                put("testUser", rateLimiter);
            }
        }).build();
        request = MLUpdateControllerRequest.builder().updateControllerInput(updateControllerInput).build();
    }
    ...
    public void writeToSuccess() throws IOException {
        ...
        MLUpdateControllerRequest parsedRequest = new MLUpdateControllerRequest(bytesStreamOutput.bytes().streamInput());
        ...
        assertEquals("1", parsedRequest.getUpdateControllerInput().getUserRateLimiter().get("testUser").getLimit());
        assertEquals(TimeUnit.MILLISECONDS, parsedRequest.getUpdateControllerInput().getUserRateLimiter().get("testUser").getUnit());
    }
    ...
    public void validateWithNullMLModelID() {
        ...
        MLUpdateControllerRequest request = MLUpdateControllerRequest.builder().updateControllerInput(updateControllerInput).build();
    ...
    public void fromActionRequestWithNonMLUpdateControllerRequestSuccess() {
        ...
        assertEquals(request.getUpdateControllerInput().getModelId(), result.getUpdateControllerInput().getModelId());
    }
