...
public class RowTest {
    ...
    public void testParse_NullValue_AtLast() throws IOException {
        ColumnValue[] values = new ColumnValue[] {new IntValue(1), new DoubleValue(2.0), new StringValue("test"), new BooleanValue(true), new NullValue()};
        Row row = new Row(values);
        testParse(row, function);
    }
    ...
    public void testParse_NullValue_AtFirst() throws IOException {
        ColumnValue[] values = new ColumnValue[] {new NullValue(), new IntValue(1), new DoubleValue(2.0), new StringValue("test"), new BooleanValue(true)};
        Row row = new Row(values);
        testParse(row, function);
    }
    ...
    public void testParse_NullValue_AtMiddle() throws IOException {
        ColumnValue[] values = new ColumnValue[] {new IntValue(1), new DoubleValue(2.0), new NullValue(), new StringValue("test"), new BooleanValue(true)};
        Row row = new Row(values);
        testParse(row, function);
    }
    ...
    public void testEquals_EmptyValues() {
        ...
        ColumnValue[] values3 = new ColumnValue[] {new IntValue(1), new DoubleValue(2.0), new NullValue(), new StringValue("test"), new BooleanValue(true)};
    ...
    public void testEquals_AllValuesMatch() {
        ColumnValue[] values1 = new ColumnValue[] {new IntValue(1), new DoubleValue(2.0), new NullValue(), new StringValue("test"), new BooleanValue(true)};
        Row row1 = new Row(values1);
        ColumnValue[] values2 = new ColumnValue[] {new IntValue(1), new DoubleValue(2.0), new NullValue(), new StringValue("test"), new BooleanValue(true)};
        Row row2 = new Row(values2);
        assertTrue(row1.equals(row2));
    }
    ...
    public void testEquals_SomeValueNotMatch() {
        ColumnValue[] values1 = new ColumnValue[] {new IntValue(1), new DoubleValue(2.0), new NullValue(), new StringValue("test"), new BooleanValue(true)};
        Row row1 = new Row(values1);
        ColumnValue[] values2 = new ColumnValue[] {new IntValue(2), new DoubleValue(2.0), new NullValue(), new StringValue("test"), new BooleanValue(true)};
        Row row2 = new Row(values2);
    ...
    public void testEquals_SomeTypeNotMatch() {
        ColumnValue[] values1 = new ColumnValue[] {new IntValue(1), new DoubleValue(2.0), new NullValue(), new StringValue("test"), new BooleanValue(true)};
        Row row1 = new Row(values1);
        ColumnValue[] values2 = new ColumnValue[] {new DoubleValue(1.0), new DoubleValue(2.0), new NullValue(), new StringValue("test"), new BooleanValue(true)};
        Row row2 = new Row(values2);
        assertFalse(row1.equals(row2));
    }
