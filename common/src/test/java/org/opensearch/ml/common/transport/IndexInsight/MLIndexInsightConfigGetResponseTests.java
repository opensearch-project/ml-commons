...
public class MLIndexInsightConfigGetResponseTests {
    ...
    @Before
    public void setUp() {
        indexInsightConfig = new IndexInsightConfig(
                true,
                "demo-tenant-id");
    }
    ...
    public void toXContentTest() throws IOException {
        MLIndexInsightConfigGetResponse mlIndexInsightConfigGetResponse = MLIndexInsightConfigGetResponse.builder().indexInsightConfig(indexInsightConfig).build();
        ...
        String expectedControllerResponse =
                "{\"is_enable\":true,\"tenant_id\":\"demo-tenant-id\"}";
    ...
    public void fromActionResponseWithMLConnectorGetResponseSuccess() {
        MLIndexInsightConfigGetResponse mlIndexInsightConfigGetResponse = MLIndexInsightConfigGetResponse.builder().indexInsightConfig(indexInsightConfig).build();
        MLIndexInsightConfigGetResponse mlIndexInsightConfigGetResponse1 = MLIndexInsightConfigGetResponse.fromActionResponse(mlIndexInsightConfigGetResponse);
    ...
    public void fromActionResponseSuccess() {
        ...
        MLIndexInsightConfigGetResponse mlIndexInsightConfigGetResponse1 = MLIndexInsightConfigGetResponse.fromActionResponse(actionResponse);
        ...
        assertEquals(mlIndexInsightConfigGetResponse.getIndexInsightConfig().getIsEnable(), mlIndexInsightConfigGetResponse1.getIndexInsightConfig().getIsEnable());
        assertEquals(mlIndexInsightConfigGetResponse.getIndexInsightConfig().getTenantId(), mlIndexInsightConfigGetResponse1.getIndexInsightConfig().getTenantId());
    }
