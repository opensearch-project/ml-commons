...
public class OpenaiV1ChatCompletionsModelProviderTest {
    ...
    public void testParseResponseMessage_ToolCalls() {
        ...
        assertNotNull(result);
        assertEquals("assistant", result.getRole());
        assertNull(result.getContent()); // null content
        ...
        assertEquals("function", result.getToolCalls().get(0).getType());
    ...
    public void testParseResponseMessage_TextAndToolCalls() {
        ...
        assertNotNull(result);
        assertEquals(1, result.getContent().size());
        assertEquals("Let me check", result.getContent().get(0).getText());
        assertEquals(1, result.getToolCalls().size());
    ...
    @Test
    public void testCreateConnector_RequestBodyContainsInferenceParams() {
        // Arrange
        String modelId = "gpt-4o";
        Map<String, String> credential = new HashMap<>();
        credential.put("openai_api_key", "test_key");
        ...
        assertTrue(requestBody.contains("max_completion_tokens"));
    ...
    public void testCreateConnector_WithTopP() {
        ...
        assertTrue(topPField.contains("\"top_p\""));
