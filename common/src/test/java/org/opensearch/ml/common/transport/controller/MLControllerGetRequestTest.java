...
public class MLControllerGetRequestTest {

    private String modelId;

    private MLControllerGetRequest request;
    ...
    public void setUp() {
        ...
        request = MLControllerGetRequest.builder().modelId(modelId).build();
    }
    ...
    public void writeToSuccess() throws IOException {
        ...
        MLControllerGetRequest parsedRequest = new MLControllerGetRequest(bytesStreamOutput.bytes().streamInput());
    ...
    public void fromActionRequestSuccess() {
        ...
        MLControllerGetRequest requestFromActionRequest = MLControllerGetRequest.fromActionRequest(actionRequest);
    ...
    public void fromActionRequestIOException() {
        ...
        MLControllerGetRequest.fromActionRequest(actionRequest);
    }

    @Test
    public void fromActionRequestWithMLControllerGetRequestSuccess() {
        MLControllerGetRequest requestFromActionRequest = MLControllerGetRequest.fromActionRequest(request);
    ...
    public void validateNullModelIdException() {
        MLControllerGetRequest request = MLControllerGetRequest.builder().build();
