...
public class BedrockCohereRerankPostProcessFunctionTest {
    @Rule
    public ExpectedException exceptionRule = ExpectedException.none();

    BedrockCohereRerankPostProcessFunction function;

    @Before
    public void setUp() {
        function = new BedrockCohereRerankPostProcessFunction();
    }
