...
public class McpToolInfoTest {
    ...
    public void testBuilder() {
        McpToolInfo info = McpToolInfo.builder().name(TOOL_NAME).description(TOOL_DESCRIPTION).inputSchema(SCHEMA_JSON).build();
    ...
    public void testBuilder_NullInputSchema() {
        McpToolInfo info = McpToolInfo.builder().name(TOOL_NAME).description(TOOL_DESCRIPTION).inputSchema(null).build();
        assertNull(info.getInputSchema());
    }

    @Test
    public void testWriteToReadFrom() throws IOException {
        McpToolInfo original = McpToolInfo.builder().name(TOOL_NAME).description(TOOL_DESCRIPTION).inputSchema(SCHEMA_JSON).build();
