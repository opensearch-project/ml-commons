...
/**
 * Request to delete an event from a memory container
 */
@Getter
public class MLDeleteEventRequest extends ActionRequest {

    private String memoryContainerId;
    private String eventId;

    public MLDeleteEventRequest(String memoryContainerId, String eventId) {
        this.memoryContainerId = memoryContainerId;
        this.eventId = eventId;
    }

    public MLDeleteEventRequest(StreamInput in) throws IOException {
        super(in);
