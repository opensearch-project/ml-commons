...
public class LoadModelInput implements ToXContentObject, Writeable {
    ...
    @Builder
    public LoadModelInput(String modelName, Integer version, String taskId, Integer nodeCount, String coordinatingNodeId, MLTask mlTask) {
    ...
    public static LoadModelInput parse(XContentParser parser) throws IOException {
        ...
        return new LoadModelInput(modelName, version, taskId, nodeCount, coordinatingNodeId, mlTask);
    }
