...
import org.opensearch.ml.common.connector.functions.preprocess.*;
...
public class MLPreProcessFunction {
    ...
    public static final String TEXT_SIMILARITY_TO_BEDROCK_COHERE_RERANK_INPUT = "connector.pre_process.bedrock.cohere.rerank";
    ...
    static {
        ...
        PRE_PROCESS_FUNCTIONS.put(TEXT_SIMILARITY_TO_BEDROCK_COHERE_RERANK_INPUT, bedrockCohereRerankPreProcessFunction);
