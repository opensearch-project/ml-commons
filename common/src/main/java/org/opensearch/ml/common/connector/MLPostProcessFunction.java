...
import org.opensearch.ml.common.connector.functions.postprocess.*;
...
public class MLPostProcessFunction {
    ...
    public static final String BEDROCK_COHERE_RERANK = "connector.post_process.bedrock.cohere.rerank";
    ...
    static {
        ...
        BedrockCohereRerankPostProcessFunction bedrockCohereRerankPostProcessFunction = new BedrockCohereRerankPostProcessFunction();
        ...
        JSON_PATH_EXPRESSION.put(BEDROCK_COHERE_RERANK, "$.results");
        JSON_PATH_EXPRESSION.put(DEFAULT_RERANK, "$[*]");
        POST_PROCESS_FUNCTIONS.put(BEDROCK_COHERE_RERANK, bedrockCohereRerankPostProcessFunction);
