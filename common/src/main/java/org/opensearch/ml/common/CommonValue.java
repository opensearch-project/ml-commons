...
public class CommonValue {
    ...
    // Index mapping paths
    public static final String ML_MODEL_GROUP_INDEX_MAPPING_PATH = "mappings/ml-model-group.json";
    ...
    public static final String ML_MEMORY_MESSAGE_INDEX_MAPPING_PATH = "mappings/ml-memory-message.json";
