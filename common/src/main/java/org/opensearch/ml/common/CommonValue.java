...
public class CommonValue {
    ...
    /**
     * Internal parameter key used to propagate the executing agent's ID through the parameter map
     * for logging purposes. Uses underscore prefix to avoid colliding with the "agent_id" tool
     * parameter used by AgentTool to specify which sub-agent to invoke.
     */
