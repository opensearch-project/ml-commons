...
public class CommonValue {
    ...
    /**
     * The field name to be inserted into a document when operating tenant aware.
     * <p>
     * The value for this field will be supplied by REST callers using {@code x-tenant-id} header. If no such header is provided, {@link #DEFAULT_TENANT} is used.
     * <p>
     * This value should be chosen to avoid conflicts with any existing or future fields.  In the future this may be replaced by a plugin setting.  
     */
    public static final String TENANT_ID = "_tenant_id";
    /**
     * The default tenant id to be used if the REST header {@code x-tenant-id} is not present.
     */
