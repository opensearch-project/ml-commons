...
public class MLRegisterModelInput implements ToXContentObject, Writeable {
    ...
    public XContentBuilder toXContent(XContentBuilder builder, Params params) throws IOException {
        ...
        builder.field(MLModel.MODEL_NAME_FIELD, modelName);
        if (version != null) {
        ...
        if (hashValue != null) {
            builder.field(MLModel.MODEL_CONTENT_HASH_VALUE_FIELD, hashValue);
        }
        if (modelFormat != null) {
        ...
        if (connector != null) {
            builder.field(MLModel.CONNECTOR_FIELD, connector);
        }
        if (connectorId != null) {
            builder.field(MLModel.CONNECTOR_ID_FIELD, connectorId);
        }
        if (backendRoles != null) {
        ...
        while (parser.nextToken() != XContentParser.Token.END_OBJECT) {
            ...
            switch (fieldName) {
                ...
                case HASH_VALUE_FIELD:
                    ...
                    break;
                case MLModel.DESCRIPTION_FIELD:
