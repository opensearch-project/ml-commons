...
public class GetInteractionsRequestTests extends OpenSearchTestCase {
    ...
    public void testFromRestRequest() throws IOException {
        ...
        Map<String, String> maxResOnly  = Map.of(ActionConstants.CONVERSATION_ID_FIELD, "cid2", 
                                                ActionConstants.REQUEST_MAX_RESULTS_FIELD, "4");
        Map<String, String> nextTokOnly = Map.of(ActionConstants.CONVERSATION_ID_FIELD, "cid3", 
                                                ActionConstants.NEXT_TOKEN_FIELD, "6");
        Map<String, String> bothFields  = Map.of(ActionConstants.CONVERSATION_ID_FIELD, "cid4",
