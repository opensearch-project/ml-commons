...
> Remote guardrails is released in OpenSearch 2.15. To read more details, see the OpenSearch document [Guardrails](https://opensearch.org/docs/latest/ml-commons-plugin/remote-models/guardrails/).
