...
**Note:** The examples below are for individual modality connectors (Option B). If using the unified multimodal connector (Option A), wrap non-text inputs in JSON format for multiple inputs:
- Text:  `"hello", "world"`
- Image: `"{\"image\": \"{{image_base64}}\"}", "{\"image\": \"{{image_base64}}\"}"`
- Video: `"{\"video\": \"{{video_base64}}\"}", "{\"video\": \"{{video_base64}}\"}"`
- Audio: `"{\"audio\": \"{{audio_base64}}\"}", "{\"audio\": \"{{audio_base64}}\"}"`
