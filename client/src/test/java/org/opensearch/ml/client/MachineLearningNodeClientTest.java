...
public class MachineLearningNodeClientTest {
    ...
    public void executeMetricsCorrelation() {
        MetricsCorrelationOutput metricsCorrelationOutput;
        ...
        MetricsCorrelationInput metricsCorrelationInput = MetricsCorrelationInput.builder().inputData(inputData).build();

        machineLearningNodeClient
            .executeAlgorithm(FunctionName.METRICS_CORRELATION, metricsCorrelationInput, executeTaskResponseActionListener);
