...
* Rename batch inference queue configuration to `dynamic_batching`, add dynamic batching cluster settings, and support updating `batch_inference_config` on models ([#5064](https://github.com/opensearch-project/ml-commons/pull/5064))
