...
public class MLAgentExecutorTest {
    ...
    @Test
    public void test_CreateReActAgent() {
        MLAgent mlAgent = MLAgent.builder().name("test_agent").type("cot").build();
        MLAgentRunner mlAgentRunner = mlAgentExecutor.getAgentRunner(mlAgent);
        Assert.assertTrue(mlAgentRunner instanceof MLReActAgentRunner);
    }
