...
public class PromptTemplate {
    ...
    // Shared constant for sub-agent failure message prefix
    // Used by both MLChatAgentRunner (to format) and MLPlanExecuteAndReflectAgentRunner (to detect)
    public static final String SUB_AGENT_FAILURE_PREFIX = "Agent failed to complete the task. Reason: ";
