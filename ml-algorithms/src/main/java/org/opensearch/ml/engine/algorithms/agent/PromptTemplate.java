...
public class PromptTemplate {
    ...
    public static final String MAX_STEP_SUMMARY_PER_SYSTEM_PROMPT = "You are a Summary Agent.\n"
        ...
        + "3. Describe each step that was performed, in order.\n"
        + "4. Summarize the inputs, methods, tools, and data used at each step.\n"
        + "5. Include all key findings and important intermediate results.\n"
        + "6.Clearly explain how the steps led to the final conclusion.\n"
        + "7. The summary must be complete enough to stand alone, without needing earlier messages.\n"
        + "8. Use a neutral, factual tone and focus only on the information provided.\n"
        + "9. Output only the summary text — no JSON or metadata.\n"
        + "\n"
        + "Rules\n"
