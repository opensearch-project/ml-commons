...
public class RCFSummarize implements TrainAndPredictable {
    ...
    public RCFSummarize(MLAlgoParams parameters) {
        this.parameters = parameters == null
            ? RCFSummarizeParams
                .builder()
                .maxK(DEFAULT_MAX_K)
                .initialK(DEFAULT_MAX_K)
                .phase1Reassign(DEFAULT_PHASE1_REASSIGN)
                .parallel(DEFAULT_PARALLEL)
                .build()
            : (RCFSummarizeParams) parameters;
    ...
    private void validateParametersAndRefine() {
        ...
        parameters = RCFSummarizeParams
            .builder()
            .maxK(maxK)
            .initialK(initialK)
            .phase1Reassign(phase1Reassign)
            .parallel(parallel)
    ...
    public MLModel train(MLInput mlInput) {
        ...
        SampleSummary summary = Summarizer
            .summarize(
                featureNamesValues.v2(),
                parameters.getMaxK(),
