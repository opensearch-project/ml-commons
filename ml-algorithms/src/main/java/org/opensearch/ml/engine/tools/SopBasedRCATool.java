...
public class SopBasedRCATool implements Tool {
    ...
    private <T> void executeStep(Map<String, String> parameters, List<String> sops, int currentStep, ActionListener<T> listener, Map<String, String> resultMap){
