...
public class MLAgentExecutor implements Executable, SettingsChangeListener {
                    ...
                    .whenComplete((response, throwable) -> {
                        ...
                        if (throwable != null) {
                            ...
                            if (ExceptionsHelper.unwrap(cause, IndexNotFoundException.class) != null) {
                                log
                                    .error(
                                        "Failed to get Agent index. agentId={}, tenantId={}",
                                        agentId,
                                ...
                                log
                                    .error(
                                        "Failed to get ML Agent. agentId={}, tenantId={}",
                                        agentId,
                                        tenantId != null ? tenantId : "",
                                        cause
                                    );
                            ...
                            try {
                                ...
                                if (getAgentResponse != null && getAgentResponse.isExists()) {
                                    try (
                                        ...
                                        log
                                            .error(
                                                "Failed to parse ml agent. agentId={}, tenantId={}",
                                                agentId,
                                                tenantId != null ? tenantId : "",
                                                e
                                            );
    ...
    void performInitialMemoryOperations(
        ...
        memory.getStructuredMessages(ActionListener.wrap(result -> {
                ...
                try {
                    ...
                    log
                        .error(
                            ...
                            mlAgent.getName(),
                            mlAgent.getTenantId() != null ? mlAgent.getTenantId() : "",
                            ex
                        );
                    listener.onFailure(ex);
                }
            ...
            log
                .error(
                    "Failed to get history. agentId={}, tenantId={}",
                    mlAgent.getName(),
                    mlAgent.getTenantId() != null ? mlAgent.getTenantId() : "",
                    e
                );
