 ...
 */
public class RestMemoryGetInteractionsAction extends BaseRestHandler {
    private final static String GET_INTERACTIONS_NAME = "conversational_get_interactions";

    @Override
    public List<Route> routes() {
        return List.of(new Route(RestRequest.Method.GET, ActionConstants.GET_INTERACTIONS_REST_PATH));
    }
