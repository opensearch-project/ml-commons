...
public class RestMLHybridSearchMemoriesAction extends BaseRestHandler {
    ...
    private MLHybridSearchMemoriesInput parseInput(RestRequest request, String memoryContainerId) throws IOException {
        ...
        float bm25Weight = MLHybridSearchMemoriesInput.DEFAULT_BM25_WEIGHT;
        float neuralWeight = MLHybridSearchMemoriesInput.DEFAULT_NEURAL_WEIGHT;
        ...
        while (parser.nextToken() != XContentParser.Token.END_OBJECT) {
            ...
            switch (fieldName) {
                ...
                case "filter":
                    ...
                    break;
                case "bm25_weight":
                    bm25Weight = parser.floatValue();
                    break;
                case "neural_weight":
                    neuralWeight = parser.floatValue();
                    break;
                default:
                    parser.skipChildren();
                    break;
