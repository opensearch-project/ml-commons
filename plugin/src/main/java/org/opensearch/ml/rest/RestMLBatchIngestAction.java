...
public class RestMLBatchIngestAction extends BaseRestHandler {
        ...
        return ImmutableList
                .of(
                        new Route(
                                ...
                                String.format(Locale.ROOT, "%s/_batch_ingestion", ML_BASE_URI)
                        )
                );
    }
    ...
    public RestChannelConsumer prepareRequest(RestRequest request, NodeClient client) throws IOException {
        ...
        return channel -> client.execute(MLCreateConnectorAction.INSTANCE, mlBatchIngestTaskRequest, new RestToXContentListener<>(channel));
    }
