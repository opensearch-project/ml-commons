...
public class RestMLDeleteAgentActionTests extends OpenSearchTestCase {
    ...
    public void testGetName() {
        String actionName = restMLDeleteAgentAction.getName();
        assertFalse(Strings.isNullOrEmpty(actionName));
        assertEquals("ml_delete_agent_action", actionName);
    }

    public void testRoutes() {
        List<RestHandler.Route> routes = restMLDeleteAgentAction.routes();
    ...
    public void test_PrepareRequest() throws Exception {
        ...
        restMLDeleteAgentAction.handleRequest(request, channel, client);

        ArgumentCaptor<MLAgentDeleteRequest> argumentCaptor = ArgumentCaptor.forClass(MLAgentDeleteRequest.class);
