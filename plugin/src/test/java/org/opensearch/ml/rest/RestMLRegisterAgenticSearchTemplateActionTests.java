...
public class RestMLRegisterAgenticSearchTemplateActionTests extends OpenSearchTestCase {
    ...
    public void tearDown() throws Exception {
        // Close resources (client depends on the thread pool) before super's teardown checks.
        client.close();
        threadPool.shutdown();
        mocks.close();
        super.tearDown();
    ...
    public void testGetRequestParsesBody() throws Exception {
        RestRequest request = bodyRequest("{\"template_id\":\"product_search\",\"index\":\"products\",\"description\":\"desc\"}");
    ...
    public void testGetRequestMissingTemplateId() throws Exception {
        ...
        IllegalArgumentException e = assertThrows(IllegalArgumentException.class, () -> restAction.getRequest(request));
        assertEquals("'template_id' is required", e.getMessage());
    }

    public void testGetRequestMissingIndex() throws Exception {
        RestRequest request = bodyRequest("{\"template_id\":\"product_search\"}");
        IllegalArgumentException e = assertThrows(IllegalArgumentException.class, () -> restAction.getRequest(request));
    ...
    public void testGetRequestAgentFrameworkDisabled() throws Exception {
        ...
        RestRequest request = bodyRequest("{\"template_id\":\"t\",\"index\":\"i\"}");
