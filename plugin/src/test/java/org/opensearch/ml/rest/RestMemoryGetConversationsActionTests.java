...
public class RestMemoryGetConversationsActionTests extends OpenSearchTestCase {
    public void testBasics() {
        RestMemoryGetConversationsAction action = new RestMemoryGetConversationsAction();
