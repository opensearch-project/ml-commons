...
public class RestMLGetContextManagementTemplateActionTests extends OpenSearchTestCase {
    private RestMLGetContextManagementTemplateAction restAction;
    ...
    public void setup() {
        ...
        restAction = new RestMLGetContextManagementTemplateAction(mlFeatureEnabledSetting);
        ...
        doAnswer(invocation -> {
            ...
            return null;
        }).when(client).execute(eq(MLGetContextManagementTemplateAction.INSTANCE), any(), any());
    }
    ...
    public void testConstructor() {
        RestMLGetContextManagementTemplateAction action = new RestMLGetContextManagementTemplateAction(mlFeatureEnabledSetting);
    ...
    public void testGetName() {
        ...
        assertEquals("ml_get_context_management_template_action", actionName);
    }
    ...
    public void testPrepareRequest() throws Exception {
        ...
        ArgumentCaptor<MLGetContextManagementTemplateRequest> argumentCaptor = ArgumentCaptor
            .forClass(MLGetContextManagementTemplateRequest.class);
        verify(client, times(1)).execute(eq(MLGetContextManagementTemplateAction.INSTANCE), argumentCaptor.capture(), any());
