...
public class RestMLGetAgenticSearchTemplateActionTests extends OpenSearchTestCase {
    private RestMLGetAgenticSearchTemplateAction restAction;
    ...
    public void setup() {
        ...
        restAction = new RestMLGetAgenticSearchTemplateAction(mlFeatureEnabledSetting);

        threadPool = new TestThreadPool(this.getClass().getSimpleName() + "ThreadPool");
        client = spy(new NodeClient(Settings.EMPTY, threadPool));
        doAnswer(invocation -> null).when(client).execute(eq(MLGetAgenticSearchTemplateAction.INSTANCE), any(), any());
    }
    ...
    public void testGetName() {
        ...
        assertEquals("ml_get_agentic_search_template_action", restAction.getName());
    }
    ...
    public void testGetRequestReadsPathParam() {
        MLGetAgenticSearchTemplateRequest result = restAction.getRequest(idRequest("product_search"));
