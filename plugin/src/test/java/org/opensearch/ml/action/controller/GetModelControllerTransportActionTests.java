...
public class GetModelControllerTransportActionTests extends OpenSearchTestCase {
    ...
    public void setup() throws IOException {
        ...
        getModelControllerTransportAction = spy(new GetModelControllerTransportAction(transportService,
                actionFilters,
                client,
                xContentRegistry,
                clusterService,
    ...
    public void testGetModelControllerWithModelAccessControlNoPermission() {
        ...
        assertEquals("User doesn't have privilege to perform this operation on this model controller, model ID: testModelId", argumentCaptor.getValue().getMessage());
    }
    ...
    public void testGetModelControllerWithModelAccessControlOtherException() {
        ...
        ArgumentCaptor<Exception> argumentCaptor = ArgumentCaptor.forClass(Exception.class);
        verify(actionListener).onFailure(argumentCaptor.capture());
        assertEquals("Any other connector access control Exception occurred. Please check log for more details.", argumentCaptor.getValue().getMessage());
    }
    ...
    public void testGetModelControllerWithGetModelNotFound() {
        ...
        ArgumentCaptor<Exception> argumentCaptor = ArgumentCaptor.forClass(Exception.class);
        verify(actionListener).onFailure(argumentCaptor.capture());
        assertEquals("Failed to find model to get the corresponding model controller with the provided model ID: testModelId", argumentCaptor.getValue().getMessage());
    }
    ...
    public GetResponse prepareModelControllerGetResponse() throws IOException {
        ...
        MLModelController modelController = MLModelController.builder()
                .modelId("testModelId")
